...
/*引脚配置*/
#define OLED_W_D0(x)		GPIO_WriteBit(GPIOC, GPIO_Pin_13, (BitAction)(x))
#define OLED_W_D1(x)		GPIO_WriteBit(GPIOC, GPIO_Pin_14, (BitAction)(x))
#define OLED_W_RES(x)		GPIO_WriteBit(GPIOC, GPIO_Pin_15, (BitAction)(x))
#define OLED_W_DC(x)		GPIO_WriteBit(GPIOC, GPIO_Pin_0, (BitAction)(x))
